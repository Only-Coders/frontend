<template>
  <div style="position: relative; margin-top: 85px; height: 765px">
    ...
    <v-row justify="center" no-gutters>
      <v-col cols="4" sm="3" md="2" lg="1">
        <v-btn text @click="showAddDialog">
          ...
          {{ $i18n.t("Onboarding.StudyExperience.addExperienceButton") }}
        </v-btn>
      </v-col>
    </v-row>
    <add-study-experience
      v-if="addDialog"
      v-model="addDialog"
      @passExperienceData="handleAddExperience"
    ></add-study-experience>
    <img
...
import AddStudyExperience from "@/components/Onboarding/StudyExperience/AddStudyExperience.vue";
...
export default Vue.extend({
  ...
  components: { Experience, AddStudyExperience, NoData },
