...
export default Vue.extend({
  ...
  components: { GeneralInformation, WorkExperience, Skill, TagStep, SuggestedContactsStep },

  data: () => ({
    carouselIndex: 0,
    steps: [GeneralInformation, WorkExperience, Skill, TagStep, SuggestedContactsStep],
